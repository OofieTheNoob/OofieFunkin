...
function onCreatePost()
    -- setProperty('showCombo', false) -- yeah i'm hardcoding the combo but not the note combo - oofie 
    ...
    getPropertyFromClass('ClientPrefs', 'showNoteCombo'))
